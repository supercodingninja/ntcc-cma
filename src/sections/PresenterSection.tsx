  ...
  return (
    <div className="space-y-5 max-w-4xl mx-auto">
      ...
      <div className="glass-card p-5 space-y-3">
        ...
        <div className="flex gap-2 flex-wrap justify-center">
          <button className="glass-btn" onClick={() => { projRef.current = openWindowWithListener('NTCCA Projector', false); setTimeout(() => push(idx, mode), 500); }}>
            🖥 Open projector window
          </button>
          <button className="glass-btn" onClick={() => { stageRef.current = openWindowWithListener('NTCCA Stage Display', true); setTimeout(() => push(idx, mode), 500); }}>
            🎤 Open stage display
          </button>
