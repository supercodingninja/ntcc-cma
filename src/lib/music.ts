...
export const INSTRUMENTS: TransposingInstrument[] = [
  { id: 'concert', label: 'Concert — Piano / Guitar', family: 'C', offset: 0, interval: 'as written' },
  { id: 'soprano', label: 'Soprano Sax (B♭)', family: 'Bb', offset: 2, interval: 'up a whole tone' },
  { id: 'tenor', label: 'Tenor Sax (B♭)', family: 'Bb', offset: 2, interval: 'up a major 9th' },
  { id: 'alto', label: 'Alto Sax (E♭)', family: 'Eb', offset: 9, interval: 'up a major 6th' },
  { id: 'baritone', label: 'Baritone Sax (E♭)', family: 'Eb', offset: 9, interval: 'up a major 13th' },
];
